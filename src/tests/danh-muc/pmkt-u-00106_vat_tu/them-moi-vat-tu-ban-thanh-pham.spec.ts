...
test.describe('PMKT-U-00106 - Thêm mới Vật tư Bán thành phẩm TC1484-TC1809', () => {
  ...
  test('TC_PMKT-U-00106-1484 - chọn Bán thành phẩm và hiển thị form thông tin tương ứng', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');

    await expect(vatTuPage.materialTypeDialog, 'Popup Chọn tính chất phải đóng sau khi chọn Bán thành phẩm').toBeHidden();
    await expect(vatTuPage.createMaterialDialog, 'Phải hiển thị popup Thêm mới vật tư').toBeVisible();
    await expect(vatTuPage.semiFinishedProductMaterialTypeField(), 'Tính chất phải hiển thị Bán thành phẩm ở trạng thái chỉ đọc').toContainText('Bán thành phẩm');
    for (const field of [
  ...
  test('TC_PMKT-U-00106-1485 - Thay đổi tính chất hiển thị lại popup đủ 6 lựa chọn', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1486 - đóng popup thay đổi và giữ nguyên Bán thành phẩm cùng dữ liệu đang nhập', async ({ vatTuPage }) => {
    const materialName = new TestDataGenerator().uniqueKeyword('TC_PMKT-U-00106-1486');
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    ...
    await expect(vatTuPage.semiFinishedProductMaterialTypeField(), 'Loại vật tư cũ phải được giữ nguyên').toContainText('Bán thành phẩm');
    await expect(vatTuPage.materialNameInput(), 'Dữ liệu đang nhập phải được giữ nguyên').toHaveValue(materialName);
  });

  test('TC_PMKT-U-00106-1487 - thay đổi tính chất từ Bán thành phẩm sang Dịch vụ', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.changeMaterialType();
  ...
  test('TC_PMKT-U-00106-1488 - hiển thị TextBox Mã vật tư bắt buộc', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1489 - nhập Mã vật tư dài 49 ký tự', async ({ vatTuPage }) => {
    const code = boundaryText('TC_PMKT-U-00106-1489', 49);
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1490 - nhập Mã vật tư dài tối đa 50 ký tự', async ({ vatTuPage }) => {
    const code = boundaryText('TC_PMKT-U-00106-1490', 50);
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.materialCodeInput().fill(code);
  ...
  test('TC_PMKT-U-00106-1491 - chặn ký tự thứ 51 của Mã vật tư', async ({ vatTuPage }) => {
    const firstFiftyCharacters = boundaryText('TC_PMKT-U-00106-1491', 50);
  ...
  test('TC_PMKT-U-00106-1492 - validate bỏ trống Mã vật tư khi Lưu', async ({ vatTuPage }) => {
    ...
    await vatTuPage.fillRequiredInventoryMaterialFields(
      '',
      new TestDataGenerator().uniqueKeyword('TC_PMKT-U-00106-1492'),
      mainUnit,
    );
  ...
  test('TC_PMKT-U-00106-1493 - validate trùng Mã vật tư đã tồn tại', async ({ vatTuPage, db }) => {
    const credentials = requireCredentials();
    ...
    await vatTuPage.fillRequiredInventoryMaterialFields(
      existingCode,
      new TestDataGenerator().uniqueKeyword('TC_PMKT-U-00106-1493'),
      mainUnit,
    );
    await vatTuPage.saveMaterial();
  ...
  test('TC_PMKT-U-00106-1494 - hiển thị TextBox Tên vật tư bắt buộc', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1495 - nhập Tên vật tư dài 254 ký tự', async ({ vatTuPage }) => {
    const name = boundaryText('TC_PMKT-U-00106-1495', 254);
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1496 - nhập Tên vật tư dài tối đa 255 ký tự', async ({ vatTuPage }) => {
    const name = boundaryText('TC_PMKT-U-00106-1496', 255);
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.materialNameInput().fill(name);
  ...
  test('TC_PMKT-U-00106-1497 - chặn ký tự thứ 256 của Tên vật tư', async ({ vatTuPage }) => {
    const firstTwoHundredFiftyFiveCharacters = boundaryText('TC_PMKT-U-00106-1497', 255);
  ...
  test('TC_PMKT-U-00106-1498 - validate bỏ trống Tên vật tư khi Lưu', async ({ vatTuPage }) => {
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    const mainUnit = await firstVisibleActiveMainUnit(vatTuPage, catalogues.units);
    ...
    if (!mainUnit) return;
    await vatTuPage.fillRequiredInventoryMaterialFields(
      new TestDataGenerator().uniqueCode('TC_PMKT-U-00106-1498'),
      '',
      mainUnit,
    );
    await vatTuPage.saveMaterial();
  ...
  test('TC_PMKT-U-00106-1499 - hiển thị Dropdown Nhóm vật tư không bắt buộc', async ({ vatTuPage }) => {
    // Hành động: Mở form Thêm mới Bán thành phẩm và quan sát control Nhóm vật tư.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1500 - hiển thị đúng dữ liệu và thứ tự Dropdown Nhóm vật tư', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1501 - Nhóm vật tư Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1502 - chọn một Nhóm vật tư', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1503 - chọn đồng thời hai Nhóm vật tư', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1504 - xóa riêng tag Nhóm vật tư thứ hai', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Chọn hai Nhóm vật tư khác nhau từ DB đúng tenant.
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
    const [firstGroup, secondGroup] = catalogues.groups;
    test.skip(!firstGroup || !secondGroup, 'DB cần tối thiểu hai Nhóm vật tư');
  ...
  test('TC_PMKT-U-00106-1505 - xóa nhanh toàn bộ Nhóm vật tư đã chọn', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Chọn hai Nhóm vật tư khác nhau từ DB đúng tenant.
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
    const [firstGroup, secondGroup] = catalogues.groups;
    test.skip(!firstGroup || !secondGroup, 'DB cần tối thiểu hai Nhóm vật tư');
  ...
  test('TC_PMKT-U-00106-1506 - hiển thị Combogrid Đơn vị tính chính bắt buộc', async ({ vatTuPage }) => {
    // Hành động: Mở form Thêm mới Bán thành phẩm và quan sát control Đơn vị tính chính.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1507 - hiển thị đúng cột, dữ liệu và thứ tự Đơn vị tính chính', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1508 - Đơn vị tính Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1509 - xác nhận sử dụng Đơn vị tính Ngừng hoạt động', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1510 - hủy sử dụng Đơn vị tính Ngừng hoạt động', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1511 - chọn Đơn vị tính chính Hoạt động không hiển thị cảnh báo', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1512 - tìm kiếm Đơn vị tính chính theo Mã', async ({ vatTuPage }) => {
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
  ...
  test('TC_PMKT-U-00106-1513 - tìm kiếm Đơn vị tính chính theo Tên', async ({ vatTuPage }) => {
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
    const keyword = discriminatingSearchKeyword(
      catalogues.units.map(({ name }) => name),
      catalogues.units.map(({ code }) => code),
  ...
  test('TC_PMKT-U-00106-1514 - tìm kiếm Đơn vị tính chính theo Trạng thái', async ({ vatTuPage }) => {
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
  ...
  test('TC_PMKT-U-00106-1515 - phím Enter chọn dòng đầu tiên của kết quả tìm kiếm', async ({ vatTuPage }) => {
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
  ...
  test('TC_PMKT-U-00106-1516 - phím Up và Down di chuyển vùng chọn', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1517 - phím ESC đóng dropdown và giữ nguyên giá trị', async ({ vatTuPage }) => {
    await openVatTuWithCatalogues(vatTuPage);
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.openMainUnitDropdown();
  ...
  test('TC_PMKT-U-00106-1518 - icon X xóa nhanh Đơn vị tính chính đã chọn', async ({ vatTuPage }) => {
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
  ...
  test('TC_PMKT-U-00106-1519 - hiển thị nút thêm nhanh Đơn vị tính với tài khoản full quyền', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.openMainUnitDropdown();
  ...
  test('TC_PMKT-U-00106-1520 - giao diện form thêm nhanh Đơn vị tính rút gọn', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1519 - tài khoản full quyền không hiển thị nút (+) Thêm nhanh Đơn vị tính');
  });

  test('TC_PMKT-U-00106-1521 - validate bắt buộc form thêm nhanh Đơn vị tính', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1519');
  });

  test('TC_PMKT-U-00106-1522 - validate trùng Mã form thêm nhanh Đơn vị tính', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1519');
  });

  test('TC_PMKT-U-00106-1523 - boundary Mã form thêm nhanh Đơn vị tính', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1519');
  });

  test('TC_PMKT-U-00106-1524 - boundary Tên form thêm nhanh Đơn vị tính', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1519');
  });

  test('TC_PMKT-U-00106-1525 - lưu thêm nhanh Đơn vị tính và tự động điền', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1519');
  });

  test('TC_PMKT-U-00106-1526 - hủy form thêm nhanh Đơn vị tính', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1519');
  });

  test('TC_PMKT-U-00106-1527 - validate bắt buộc Đơn vị tính chính', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1528 - hiển thị checkbox Giảm thuế theo quy định không bắt buộc', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1529 - checkbox Giảm thuế mặc định false và thay đổi được', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1530 - hiển thị Numeric Thời hạn bảo hành không bắt buộc', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1531 - nhập thời hạn bảo hành nguyên dương và chọn Tháng', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1532 - validate thời hạn bảo hành với số âm, số 0 và số thập phân', async ({ vatTuPage }) => {
    const data = new TestDataGenerator();
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
    const activeUnit = catalogues.units.find(({ status }) => status === 'HoatDong');
  ...
  test('TC_PMKT-U-00106-1533 - ẩn thời hạn bảo hành khi đổi sang Dịch vụ', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.changeMaterialType();
  ...
  test('TC_PMKT-U-00106-1534 - reset thời hạn bảo hành khi đổi sang loại vật tư khác', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.fillFormField('Thời hạn bảo hành', '12');
  ...
  test('TC_PMKT-U-00106-1535 - hiển thị TextArea Mô tả không bắt buộc', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1536 - boundary Mô tả 499 ký tự', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Sinh Mô tả traceable dài 499 ký tự theo cận testcase.
    const input = boundaryText('TC_PMKT-U-00106-1536', 499);
    // Hành động: Mở form Bán thành phẩm > nhập Mô tả.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1537 - boundary Mô tả 500 ký tự', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Sinh Mô tả traceable dài 500 ký tự theo cận testcase.
    const input = boundaryText('TC_PMKT-U-00106-1537', 500);
    // Hành động: Mở form Bán thành phẩm > nhập Mô tả.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1538 - boundary Mô tả 501 ký tự', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Sinh Mô tả traceable dài 501 ký tự theo cận testcase.
    const input = boundaryText('TC_PMKT-U-00106-1538', 501);
    // Hành động: Mở form Bán thành phẩm > nhập Mô tả.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1539 - hiển thị TextBox Tên vật tư khi mua không bắt buộc', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1540 - boundary Tên vật tư khi mua 254 ký tự', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Sinh Tên vật tư khi mua traceable dài 254 ký tự theo cận testcase.
    const input = boundaryText('TC_PMKT-U-00106-1540', 254);
    // Hành động: Mở form Bán thành phẩm > nhập Tên vật tư khi mua.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1541 - boundary Tên vật tư khi mua 255 ký tự', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Sinh Tên vật tư khi mua traceable dài 255 ký tự theo cận testcase.
    const input = boundaryText('TC_PMKT-U-00106-1541', 255);
    // Hành động: Mở form Bán thành phẩm > nhập Tên vật tư khi mua.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1542 - boundary Tên vật tư khi mua 256 ký tự', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Sinh Tên vật tư khi mua traceable dài 256 ký tự theo cận testcase.
    const input = boundaryText('TC_PMKT-U-00106-1542', 256);
    // Hành động: Mở form Bán thành phẩm > nhập Tên vật tư khi mua.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1543 - hiển thị TextBox Tên vật tư khi bán không bắt buộc', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1544 - boundary Tên vật tư khi bán 254 ký tự', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Sinh Tên vật tư khi bán traceable dài 254 ký tự theo cận testcase.
    const input = boundaryText('TC_PMKT-U-00106-1544', 254);
    // Hành động: Mở form Bán thành phẩm > nhập Tên vật tư khi bán.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1545 - boundary Tên vật tư khi bán 255 ký tự', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Sinh Tên vật tư khi bán traceable dài 255 ký tự theo cận testcase.
    const input = boundaryText('TC_PMKT-U-00106-1545', 255);
    // Hành động: Mở form Bán thành phẩm > nhập Tên vật tư khi bán.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1546 - boundary Tên vật tư khi bán 256 ký tự', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Sinh Tên vật tư khi bán traceable dài 256 ký tự theo cận testcase.
    const input = boundaryText('TC_PMKT-U-00106-1546', 256);
    // Hành động: Mở form Bán thành phẩm > nhập Tên vật tư khi bán.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1547 - Tên vật tư khi mua tự điền và cho phép sửa độc lập', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1548 - Tên vật tư khi bán tự điền và cho phép sửa độc lập', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.fillFormField('Tên vật tư', 'VT_TEST_001');
  ...
  test('TC_PMKT-U-00106-1549 - hiển thị control Ảnh không bắt buộc', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1550 - tải ảnh JPG 1.5MB', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Dùng ảnh JPG 1.5MB đúng cận dung lượng của testcase.
    // Hành động: Mở form Bán thành phẩm > tải ảnh.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1551 - tải ảnh JPG 2MB', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1553 - tải ảnh PNG 1.5MB', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1554 - tải ảnh PNG 2MB', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1556 - tải ảnh WEBP 1.5MB', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1557 - tải ảnh WEBP 2MB', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1552 - chặn ảnh JPG 2.1MB', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Dùng ảnh JPG 2.1MB vượt giới hạn.
    // Hành động: Mở form Bán thành phẩm > chọn ảnh vượt dung lượng.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1555 - chặn ảnh PNG 2.1MB', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1558 - chặn ảnh WEBP 2.1MB', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1559 - chặn file PDF không phải định dạng ảnh hợp lệ', async ({ vatTuPage }) => {
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1560 - ẩn trường Ảnh khi đổi sang Dịch vụ', async ({ vatTuPage }) => {
    // Hành động: Mở form Bán thành phẩm > Thay đổi tính chất > chọn Dịch vụ.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.changeMaterialType();
  ...
  test('TC_PMKT-U-00106-1561 - reset ảnh khi đổi sang loại vật tư khác', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm và tải một ảnh JPG hợp lệ.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.uploadMaterialImage('test-data/danh-muc/vat-tu/tc074-material-1_5mb.jpg');
    ...
    // Hành động: Thay đổi tính chất > chọn Bán thành phẩm.
    await vatTuPage.changeMaterialType();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1562 - hiển thị Toggle Trạng thái bắt buộc', async ({ vatTuPage }) => {
    // Hành động: Mở form Bán thành phẩm và quan sát trường Trạng thái.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1563 - Trạng thái mặc định Hoạt động và thay đổi được', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1564 - tự điền 7 tài khoản theo cấu hình Bán thành phẩm trong DB', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy cấu hình tài khoản Loại vật tư Bán thành phẩm trong đúng tenant.
    const expectedAccounts = await materialTypeDefaultAccountsFromDatabase('NVL');
    test.skip(!expectedAccounts, 'DB không có cấu hình Loại vật tư Bán thành phẩm mã NVL trong tenant hiện tại');
    if (!expectedAccounts) return;

    // Hành động: Mở form Bán thành phẩm và chuyển sang tab Hạch toán ngầm định.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    const actualAccounts = await vatTuPage.readDefaultAccountingAccounts();

    // Xác nhận UI/DB: Toàn bộ bảy tài khoản tự điền khớp cấu hình Loại vật tư Bán thành phẩm.
    expect(actualAccounts, 'Bảy tài khoản ngầm định trên UI phải khớp cấu hình mst_loai_vat_tu').toEqual(expectedAccounts);
  });

  test('TC_PMKT-U-00106-1565 - hiển thị Combogrid Tài khoản vật tư không bắt buộc', async ({ vatTuPage }) => {
    // Hành động: Mở form Bán thành phẩm và chuyển sang tab Hạch toán ngầm định.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1566 - hiển thị đúng cột, dữ liệu và thứ tự Tài khoản vật tư', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán và toàn bộ Tài khoản Ngừng hoạt động.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1567 - Tài khoản vật tư Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1568 - xác nhận sử dụng Tài khoản vật tư Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK vì TC1567 xác nhận combogrid hiện không hiển thị Tài khoản Ngừng hoạt động.
    test.skip(true, 'BLOCK: bị chặn bởi TC1567 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1569 - hủy sử dụng Tài khoản vật tư Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK vì TC1567 xác nhận combogrid hiện không hiển thị Tài khoản Ngừng hoạt động.
    test.skip(true, 'BLOCK: bị chặn bởi TC1567 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1570 - chọn Tài khoản vật tư Hoạt động không hiển thị cảnh báo', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1571 - tìm Tài khoản vật tư theo Số hiệu TK', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1572 - tìm Tài khoản vật tư theo Tên TK', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1573 - tìm Tài khoản vật tư theo Trạng thái', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1574 - Enter chọn dòng Tài khoản vật tư đầu tiên', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1575 - phím Up và Down di chuyển từng dòng Tài khoản vật tư', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1576 - ESC đóng dropdown Tài khoản vật tư không đổi giá trị', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu UI: Ghi nhận giá trị hiện tại rồi mở combogrid.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const accountCombobox = vatTuPage.inventoryMaterialFormFieldControl('Tài khoản vật tư', 'combobox');
    const valueBefore = await accountCombobox.inputValue();
    await vatTuPage.openAccountingAccountDropdown('Tài khoản vật tư');
  ...
  test('TC_PMKT-U-00106-1577 - icon X xóa nhanh Tài khoản vật tư', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1578 - ẩn Tài khoản vật tư khi đổi sang Dịch vụ', async ({ vatTuPage }) => {
    // Hành động: Mở Bán thành phẩm > tab Hạch toán > Thay đổi tính chất > Dịch vụ > tab Hạch toán.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.openDefaultAccountingTab();
  ...
  test('TC_PMKT-U-00106-1579 - reset Tài khoản vật tư khi đổi sang loại vật tư khác', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Chọn một Tài khoản vật tư hợp lệ trên form Bán thành phẩm.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
    if (!activeAccount) return;
    ...
    // Hành động: Thay đổi tính chất > chọn Bán thành phẩm > mở Hạch toán ngầm định.
    await vatTuPage.changeMaterialType();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.openDefaultAccountingTab();

    // Xác nhận UI: Giá trị Tài khoản vật tư đã chọn trên Bán thành phẩm bị xóa sạch.
  ...
  test('TC_PMKT-U-00106-1580 - hiển thị combogrid Tài khoản giá vốn không bắt buộc', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm tại tab Hạch toán ngầm định.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1581 - hiển thị đúng cột, dữ liệu và thứ tự Tài khoản giá vốn', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán và toàn bộ Tài khoản Ngừng hoạt động.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedAccounts = accounts.filter(
      (account) => account.allowed || account.status === 'NgungHoatDong',
  ...
  test('TC_PMKT-U-00106-1582 - Tài khoản giá vốn Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Ngừng hoạt động, không ràng buộc Cho phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const inactiveAccount = accounts.find((account) => account.status === 'NgungHoatDong');
    test.skip(!inactiveAccount, 'BLOCK: DB tenant hiện tại không có Tài khoản Ngừng hoạt động');
  ...
  test('TC_PMKT-U-00106-1583 - xác nhận sử dụng Tài khoản giá vốn Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1582 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1582 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1584 - hủy sử dụng Tài khoản giá vốn Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1582 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1582 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1585 - chọn Tài khoản giá vốn Hoạt động không hiển thị cảnh báo', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1586 - tìm Tài khoản giá vốn theo Số hiệu TK', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1587 - tìm Tài khoản giá vốn theo Tên TK', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1588 - tìm Tài khoản giá vốn theo Trạng thái', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1589 - Enter chọn dòng Tài khoản giá vốn đầu tiên', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1590 - phím Up và Down di chuyển từng dòng Tài khoản giá vốn', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Mở combogrid có tối thiểu ba Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    test.skip(accounts.filter((account) => account.allowed).length < 3, 'DB có ít hơn ba Tài khoản được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1591 - ESC đóng dropdown Tài khoản giá vốn không đổi giá trị', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu UI: Ghi nhận giá trị hiện tại rồi mở combogrid.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const accountCombobox = vatTuPage.inventoryMaterialFormFieldControl('Tài khoản giá vốn', 'combobox');
    const valueBefore = await accountCombobox.inputValue();
  ...
  test('TC_PMKT-U-00106-1592 - icon X xóa nhanh Tài khoản giá vốn', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Chọn một Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1593 - ẩn Tài khoản giá vốn khi đổi sang Dịch vụ', async ({ vatTuPage }) => {
    // Hành động: Mở Bán thành phẩm > Hạch toán > Thay đổi tính chất > Dịch vụ > Hạch toán.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.openDefaultAccountingTab();
  ...
  test('TC_PMKT-U-00106-1594 - reset Tài khoản giá vốn khi đổi sang loại vật tư khác', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Chọn một Tài khoản giá vốn hợp lệ trên form Bán thành phẩm.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
    if (!activeAccount) return;
    ...
    // Xác nhận UI: Giá trị Tài khoản giá vốn đã chọn trên Bán thành phẩm bị xóa sạch.
  ...
  test('TC_PMKT-U-00106-1595 - hiển thị combogrid Tài khoản doanh thu không bắt buộc', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm tại tab Hạch toán ngầm định.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1596 - hiển thị đúng cột, dữ liệu và thứ tự Tài khoản doanh thu', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán và toàn bộ Tài khoản Ngừng hoạt động.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedAccounts = accounts.filter(
      (account) => account.allowed || account.status === 'NgungHoatDong',
  ...
  test('TC_PMKT-U-00106-1597 - Tài khoản doanh thu Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Ngừng hoạt động, không ràng buộc Cho phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const inactiveAccount = accounts.find((account) => account.status === 'NgungHoatDong');
    test.skip(!inactiveAccount, 'BLOCK: DB tenant hiện tại không có Tài khoản Ngừng hoạt động');
  ...
  test('TC_PMKT-U-00106-1598 - xác nhận sử dụng Tài khoản doanh thu Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1597 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1597 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1599 - hủy sử dụng Tài khoản doanh thu Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1597 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1597 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1600 - chọn Tài khoản doanh thu Hoạt động không hiển thị cảnh báo', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1601 - tìm Tài khoản doanh thu theo Số hiệu TK', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa chỉ thuộc Số hiệu TK trong tập được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = discriminatingSearchKeyword(
  ...
  test('TC_PMKT-U-00106-1602 - tìm Tài khoản doanh thu theo Tên TK', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa chỉ thuộc Tên TK trong tập được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = discriminatingSearchKeyword(
  ...
  test('TC_PMKT-U-00106-1603 - tìm Tài khoản doanh thu theo Trạng thái', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedLabels = accounts
      .filter((account) => account.allowed && account.status === 'HoatDong')
  ...
  test('TC_PMKT-U-00106-1604 - Enter chọn dòng Tài khoản doanh thu đầu tiên', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa trả về nhiều Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = sharedSearchKeyword(allowedAccounts.map((account) => account.code));
  ...
  test('TC_PMKT-U-00106-1605 - phím Up và Down di chuyển từng dòng Tài khoản doanh thu', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Mở combogrid có tối thiểu ba Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    test.skip(accounts.filter((account) => account.allowed).length < 3, 'DB có ít hơn ba Tài khoản được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1606 - ESC đóng dropdown Tài khoản doanh thu không đổi giá trị', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu UI: Ghi nhận giá trị hiện tại rồi mở combogrid.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const accountCombobox = vatTuPage.inventoryMaterialFormFieldControl('Tài khoản doanh thu', 'combobox');
    const valueBefore = await accountCombobox.inputValue();
  ...
  test('TC_PMKT-U-00106-1607 - icon X xóa nhanh Tài khoản doanh thu', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Chọn một Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1608 - hiển thị combogrid Tài khoản hàng bán trả lại không bắt buộc', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm tại tab Hạch toán ngầm định.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1609 - hiển thị đúng cột, dữ liệu và thứ tự Tài khoản hàng bán trả lại', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán và toàn bộ Tài khoản Ngừng hoạt động.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedAccounts = accounts.filter(
      (account) => account.allowed || account.status === 'NgungHoatDong',
  ...
  test('TC_PMKT-U-00106-1610 - Tài khoản hàng bán trả lại Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Ngừng hoạt động, không ràng buộc Cho phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const inactiveAccount = accounts.find((account) => account.status === 'NgungHoatDong');
    test.skip(!inactiveAccount, 'BLOCK: DB tenant hiện tại không có Tài khoản Ngừng hoạt động');
  ...
  test('TC_PMKT-U-00106-1611 - xác nhận sử dụng Tài khoản hàng bán trả lại Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1610 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1610 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1612 - hủy sử dụng Tài khoản hàng bán trả lại Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1610 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1610 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1613 - chọn Tài khoản hàng bán trả lại Hoạt động không hiển thị cảnh báo', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1614 - tìm Tài khoản hàng bán trả lại theo Số hiệu TK', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa chỉ thuộc Số hiệu TK trong tập được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = discriminatingSearchKeyword(
  ...
  test('TC_PMKT-U-00106-1615 - tìm Tài khoản hàng bán trả lại theo Tên TK', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa chỉ thuộc Tên TK trong tập được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = discriminatingSearchKeyword(
  ...
  test('TC_PMKT-U-00106-1616 - tìm Tài khoản hàng bán trả lại theo Trạng thái', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedLabels = accounts
      .filter((account) => account.allowed && account.status === 'HoatDong')
  ...
  test('TC_PMKT-U-00106-1617 - Enter chọn dòng Tài khoản hàng bán trả lại đầu tiên', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa trả về nhiều Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = sharedSearchKeyword(allowedAccounts.map((account) => account.code));
  ...
  test('TC_PMKT-U-00106-1618 - phím Up và Down di chuyển từng dòng Tài khoản hàng bán trả lại', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Mở combogrid có tối thiểu ba Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    test.skip(accounts.filter((account) => account.allowed).length < 3, 'DB có ít hơn ba Tài khoản được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1619 - ESC đóng dropdown Tài khoản hàng bán trả lại không đổi giá trị', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu UI: Ghi nhận giá trị hiện tại rồi mở combogrid.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const accountCombobox = vatTuPage.inventoryMaterialFormFieldControl('Tài khoản hàng bán trả lại', 'combobox');
    const valueBefore = await accountCombobox.inputValue();
  ...
  test('TC_PMKT-U-00106-1620 - icon X xóa nhanh Tài khoản hàng bán trả lại', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Chọn một Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1621 - hiển thị combogrid Tài khoản chi phí không bắt buộc', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm tại tab Hạch toán ngầm định.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1622 - hiển thị đúng cột, dữ liệu và thứ tự Tài khoản chi phí', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán và toàn bộ Tài khoản Ngừng hoạt động.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedAccounts = accounts.filter(
      (account) => account.allowed || account.status === 'NgungHoatDong',
  ...
  test('TC_PMKT-U-00106-1623 - Tài khoản chi phí Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Ngừng hoạt động, không ràng buộc Cho phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const inactiveAccount = accounts.find((account) => account.status === 'NgungHoatDong');
    test.skip(!inactiveAccount, 'BLOCK: DB tenant hiện tại không có Tài khoản Ngừng hoạt động');
  ...
  test('TC_PMKT-U-00106-1624 - xác nhận sử dụng Tài khoản chi phí Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1623 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1623 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1625 - hủy sử dụng Tài khoản chi phí Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1623 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1623 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1626 - chọn Tài khoản chi phí Hoạt động không hiển thị cảnh báo', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1627 - tìm Tài khoản chi phí theo Số hiệu TK', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa chỉ thuộc Số hiệu TK trong tập được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = discriminatingSearchKeyword(
  ...
  test('TC_PMKT-U-00106-1628 - tìm Tài khoản chi phí theo Tên TK', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa chỉ thuộc Tên TK trong tập được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = discriminatingSearchKeyword(
  ...
  test('TC_PMKT-U-00106-1629 - tìm Tài khoản chi phí theo Trạng thái', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedLabels = accounts
      .filter((account) => account.allowed && account.status === 'HoatDong')
  ...
  test('TC_PMKT-U-00106-1630 - Enter chọn dòng Tài khoản chi phí đầu tiên', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa trả về nhiều Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = sharedSearchKeyword(allowedAccounts.map((account) => account.code));
  ...
  test('TC_PMKT-U-00106-1631 - phím Up và Down di chuyển từng dòng Tài khoản chi phí', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Mở combogrid có tối thiểu ba Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    test.skip(accounts.filter((account) => account.allowed).length < 3, 'DB có ít hơn ba Tài khoản được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1632 - ESC đóng dropdown Tài khoản chi phí không đổi giá trị', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu UI: Ghi nhận giá trị hiện tại rồi mở combogrid.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const accountCombobox = vatTuPage.inventoryMaterialFormFieldControl('Tài khoản chi phí', 'combobox');
    const valueBefore = await accountCombobox.inputValue();
  ...
  test('TC_PMKT-U-00106-1633 - icon X xóa nhanh Tài khoản chi phí', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Chọn một Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1634 - hiển thị combogrid Tài khoản chiết khấu không bắt buộc', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm tại tab Hạch toán ngầm định.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1635 - hiển thị đúng cột, dữ liệu và thứ tự Tài khoản chiết khấu', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán và toàn bộ Tài khoản Ngừng hoạt động.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedAccounts = accounts.filter(
      (account) => account.allowed || account.status === 'NgungHoatDong',
  ...
  test('TC_PMKT-U-00106-1636 - Tài khoản chiết khấu Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Ngừng hoạt động, không ràng buộc Cho phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const inactiveAccount = accounts.find((account) => account.status === 'NgungHoatDong');
    test.skip(!inactiveAccount, 'BLOCK: DB tenant hiện tại không có Tài khoản Ngừng hoạt động');
  ...
  test('TC_PMKT-U-00106-1637 - xác nhận sử dụng Tài khoản chiết khấu Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1636 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1636 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1638 - hủy sử dụng Tài khoản chiết khấu Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1636 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1636 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1639 - chọn Tài khoản chiết khấu Hoạt động không hiển thị cảnh báo', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1640 - tìm Tài khoản chiết khấu theo Số hiệu TK', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa chỉ thuộc Số hiệu TK trong tập được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = discriminatingSearchKeyword(
  ...
  test('TC_PMKT-U-00106-1641 - tìm Tài khoản chiết khấu theo Tên TK', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa chỉ thuộc Tên TK trong tập được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = discriminatingSearchKeyword(
  ...
  test('TC_PMKT-U-00106-1642 - tìm Tài khoản chiết khấu theo Trạng thái', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedLabels = accounts
      .filter((account) => account.allowed && account.status === 'HoatDong')
  ...
  test('TC_PMKT-U-00106-1643 - Enter chọn dòng Tài khoản chiết khấu đầu tiên', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa trả về nhiều Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = sharedSearchKeyword(allowedAccounts.map((account) => account.code));
  ...
  test('TC_PMKT-U-00106-1644 - phím Up và Down di chuyển từng dòng Tài khoản chiết khấu', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Mở combogrid có tối thiểu ba Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    test.skip(accounts.filter((account) => account.allowed).length < 3, 'DB có ít hơn ba Tài khoản được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1645 - ESC đóng dropdown Tài khoản chiết khấu không đổi giá trị', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu UI: Ghi nhận giá trị hiện tại rồi mở combogrid.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const accountCombobox = vatTuPage.inventoryMaterialFormFieldControl('Tài khoản chiết khấu', 'combobox');
    const valueBefore = await accountCombobox.inputValue();
  ...
  test('TC_PMKT-U-00106-1646 - icon X xóa nhanh Tài khoản chiết khấu', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Chọn một Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1647 - hiển thị combogrid Tài khoản giảm giá không bắt buộc', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm tại tab Hạch toán ngầm định.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1648 - hiển thị đúng cột, dữ liệu và thứ tự Tài khoản giảm giá', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán và toàn bộ Tài khoản Ngừng hoạt động.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedAccounts = accounts.filter(
      (account) => account.allowed || account.status === 'NgungHoatDong',
  ...
  test('TC_PMKT-U-00106-1649 - Tài khoản giảm giá Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Ngừng hoạt động, không ràng buộc Cho phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const inactiveAccount = accounts.find((account) => account.status === 'NgungHoatDong');
    test.skip(!inactiveAccount, 'BLOCK: DB tenant hiện tại không có Tài khoản Ngừng hoạt động');
  ...
  test('TC_PMKT-U-00106-1650 - xác nhận sử dụng Tài khoản giảm giá Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1649 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1649 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1651 - hủy sử dụng Tài khoản giảm giá Ngừng hoạt động', async () => {
    // Chuẩn bị dữ liệu: BLOCK bởi TC1649 vì combogrid không hiển thị Tài khoản Ngừng hoạt động để chọn.
    test.skip(true, 'BLOCK: bị chặn bởi TC1649 - combogrid không hiển thị Tài khoản Ngừng hoạt động');
  });

  test('TC_PMKT-U-00106-1652 - chọn Tài khoản giảm giá Hoạt động không hiển thị cảnh báo', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn một tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1653 - tìm Tài khoản giảm giá theo Số hiệu TK', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa chỉ thuộc Số hiệu TK trong tập được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = discriminatingSearchKeyword(
  ...
  test('TC_PMKT-U-00106-1654 - tìm Tài khoản giảm giá theo Tên TK', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa chỉ thuộc Tên TK trong tập được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = discriminatingSearchKeyword(
  ...
  test('TC_PMKT-U-00106-1655 - tìm Tài khoản giảm giá theo Trạng thái', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Lấy Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const expectedLabels = accounts
      .filter((account) => account.allowed && account.status === 'HoatDong')
  ...
  test('TC_PMKT-U-00106-1656 - Enter chọn dòng Tài khoản giảm giá đầu tiên', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB: Chọn từ khóa trả về nhiều Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const allowedAccounts = accounts.filter((account) => account.allowed);
    const keyword = sharedSearchKeyword(allowedAccounts.map((account) => account.code));
  ...
  test('TC_PMKT-U-00106-1657 - phím Up và Down di chuyển từng dòng Tài khoản giảm giá', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Mở combogrid có tối thiểu ba Tài khoản được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    test.skip(accounts.filter((account) => account.allowed).length < 3, 'DB có ít hơn ba Tài khoản được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1658 - ESC đóng dropdown Tài khoản giảm giá không đổi giá trị', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu UI: Ghi nhận giá trị hiện tại rồi mở combogrid.
    await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const accountCombobox = vatTuPage.inventoryMaterialFormFieldControl('Tài khoản giảm giá', 'combobox');
    const valueBefore = await accountCombobox.inputValue();
  ...
  test('TC_PMKT-U-00106-1659 - icon X xóa nhanh Tài khoản giảm giá', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu DB/UI: Chọn một Tài khoản Hoạt động được phép hạch toán.
    const accounts = await prepareGoodsAccounting(vatTuPage, 'Bán thành phẩm');
    const activeAccount = accounts.find((account) => account.allowed && account.status === 'HoatDong');
    test.skip(!activeAccount, 'DB không có Tài khoản Hoạt động được phép hạch toán');
  ...
  test('TC_PMKT-U-00106-1660 - ẩn Tab Thông tin kho khi đổi từ Bán thành phẩm sang Dịch vụ', async ({ vatTuPage }) => {
    // Chuẩn bị: Mở form Bán thành phẩm tại Tab Thông tin kho.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.openFormTab('Thông tin kho');
  ...
  test('TC_PMKT-U-00106-1661 - hiển thị lại Tab Thông tin kho khi đổi từ Dịch vụ sang Bán thành phẩm', async ({ vatTuPage }) => {
    // Chuẩn bị: Mở Bán thành phẩm rồi đổi sang Dịch vụ để Tab Thông tin kho bị ẩn.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.changeMaterialType();
    ...
    // Hành động: Thay đổi tính chất và chọn lại Bán thành phẩm.
    await vatTuPage.changeMaterialType();
    await vatTuPage.selectMaterialType('Bán thành phẩm');

    // Xác nhận: Popup đóng, form Bán thành phẩm được tải và Tab Thông tin kho hiển thị lại.
    await expect(vatTuPage.materialTypeDialog, 'Popup chọn tính chất phải đóng sau khi chọn Bán thành phẩm').toBeHidden();
    await expect(vatTuPage.semiFinishedProductMaterialTypeField(), 'Form phải hiển thị Loại vật tư Bán thành phẩm').toContainText('Bán thành phẩm');
    await expect(vatTuPage.formTab('Thông tin kho'), 'Form Bán thành phẩm phải hiển thị lại Tab Thông tin kho').toBeVisible();
  });
  test('TC_PMKT-U-00106-1662 - hiển thị combogrid Kho mặc định không bắt buộc', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm tại tab Thông tin kho.
    await openGoodsWarehouse(vatTuPage, 'Bán thành phẩm');
    // Xác nhận UI: Đúng label, control combogrid và không có dấu bắt buộc.
  ...
  test('TC_PMKT-U-00106-1663 - hiển thị đúng cột, dữ liệu và thứ tự Kho mặc định', async ({ vatTuPage, db }) => {
    // Chuẩn bị dữ liệu: Lấy ENT_Kho và mở combogrid Kho mặc định.
    const warehouses = await prepareGoodsWarehouses(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1664 - Kho Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1665 - xác nhận sử dụng Kho Ngừng hoạt động', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1666 - hủy sử dụng Kho Ngừng hoạt động', async ({ vatTuPage, db }) => {
    // Chuẩn bị: Chọn một Kho Ngừng hoạt động đồng thời tồn tại trong DB và hiển thị trên UI.
    const warehouses = await prepareGoodsWarehouses(vatTuPage, db, 'Bán thành phẩm');
    const actualLabels = await vatTuPage.visibleWarehouseLabels();
    const inactive = warehouses.find(
  ...
  test('TC_PMKT-U-00106-1667 - chọn Kho Hoạt động', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1668 - tìm Kho mặc định theo Mã kho', async ({ vatTuPage, db }) => {
    const warehouses = await prepareGoodsWarehouses(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1669 - tìm Kho mặc định theo Tên kho', async ({ vatTuPage, db }) => {
    const warehouses = await prepareGoodsWarehouses(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1670 - tìm Kho mặc định theo Trạng thái', async ({ vatTuPage, db }) => {
    const warehouses = await prepareGoodsWarehouses(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1671 - Enter chọn dòng Kho đầu tiên', async ({ vatTuPage, db }) => {
    const warehouses = await prepareGoodsWarehouses(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1672 - Up và Down di chuyển từng dòng Kho', async ({ vatTuPage }) => {
    await openGoodsWarehouse(vatTuPage, 'Bán thành phẩm');
    const valueBefore = await vatTuPage.warehouseCombobox().inputValue();
  ...
  test('TC_PMKT-U-00106-1673 - ESC đóng dropdown Kho mặc định', async ({ vatTuPage }) => {
    await openGoodsWarehouse(vatTuPage, 'Bán thành phẩm');
    const valueBefore = await vatTuPage.warehouseCombobox().inputValue();
  ...
  test('TC_PMKT-U-00106-1674 - icon X xóa Kho mặc định', async ({ vatTuPage, db }) => {
    const warehouses = await prepareGoodsWarehouses(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1676 - giao diện form Thêm nhanh Kho', async ({ vatTuPage }) => {
    await openGoodsWarehouse(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1677 - validate bắt buộc form Thêm nhanh Kho', async ({ vatTuPage }) => {
    await openGoodsWarehouse(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.openWarehouseQuickAdd();
  ...
  test('TC_PMKT-U-00106-1678 - validate trùng Mã kho khi Thêm nhanh', async ({ vatTuPage, db }) => {
    const credentials = requireCredentials();
  ...
  test('TC_PMKT-U-00106-1679 - boundary Mã kho tối đa 50 ký tự', async ({ vatTuPage }) => {
    await openGoodsWarehouse(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.openWarehouseQuickAdd();
  ...
  test('TC_PMKT-U-00106-1680 - boundary Tên kho tối đa 255 ký tự', async ({ vatTuPage }) => {
    await openGoodsWarehouse(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.openWarehouseQuickAdd();
  ...
  test('TC_PMKT-U-00106-1681 - lưu Thêm nhanh Kho và tự động điền', async ({ vatTuPage, db, quickAddCleanup }) => {
    const credentials = requireCredentials();
  ...
  test('TC_PMKT-U-00106-1682 - hủy form Thêm nhanh Kho', async ({ vatTuPage, db }) => {
    const credentials = requireCredentials();
  ...
  test('TC_PMKT-U-00106-1683 - hiển thị control Tồn tối thiểu', async ({ vatTuPage }) => {
    await openGoodsInventoryTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1684 - validate Tồn tối thiểu không nhận số âm', async ({ vatTuPage }) => {
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
  ...
  test('TC_PMKT-U-00106-1685 - hiển thị control Tồn tối đa', async ({ vatTuPage }) => {
    await openGoodsInventoryTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1686 - validate Tồn tối đa không nhận số âm', async ({ vatTuPage }) => {
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
    const unit = catalogues.units.find(({ status }) => status === 'HoatDong');
    test.skip(!unit, 'BLOCK: DB đúng tenant chưa có Đơn vị tính Hoạt động');
    if (!unit) return;
  ...
  test('TC_PMKT-U-00106-1687 - validate Tồn tối đa nhỏ hơn Tồn tối thiểu', async ({ vatTuPage }) => {
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
    const unit = catalogues.units.find(({ status }) => status === 'HoatDong');
    test.skip(!unit, 'BLOCK: DB đúng tenant chưa có Đơn vị tính Hoạt động');
    if (!unit) return;
  ...
  test('TC_PMKT-U-00106-1688 - hiển thị control Phương pháp tính giá bắt buộc', async ({ vatTuPage }) => {
    await openGoodsInventoryTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1689 - danh sách Phương pháp tính giá đầy đủ', async ({ vatTuPage }) => {
    await openGoodsInventoryTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1690 - chọn Bình quân gia quyền tức thời', async ({ vatTuPage }) => {
    await openGoodsInventoryTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1691 - thay đổi Phương pháp tính giá', async ({ vatTuPage }) => {
    await openGoodsInventoryTab(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.selectPricingMethod('Bình quân gia quyền tức thời');
  ...
  test('TC_PMKT-U-00106-1692 - validate bắt buộc Phương pháp tính giá', async ({ vatTuPage }) => {
    const catalogues = await openVatTuWithCatalogues(vatTuPage);
    const unit = catalogues.units.find(({ status }) => status === 'HoatDong');
    test.skip(!unit, 'BLOCK: DB đúng tenant chưa có Đơn vị tính Hoạt động');
    if (!unit) return;
  ...
  test('TC_PMKT-U-00106-1695 - hiển thị checkbox Theo dõi lô không bắt buộc', async ({ vatTuPage }) => {
    await openGoodsInventoryTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1696 - checkbox Theo dõi lô mặc định false và tích chọn được', async ({ vatTuPage }) => {
    await openGoodsInventoryTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1697 - hiển thị checkbox Theo dõi mã vạch không bắt buộc', async ({ vatTuPage }) => {
    await openGoodsInventoryTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1698 - checkbox Theo dõi mã vạch mặc định false và tích chọn được', async ({ vatTuPage }) => {
    await openGoodsInventoryTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1699 - hiển thị select Thuế suất GTGT mặc định không bắt buộc', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1700 - danh sách Thuế suất GTGT mặc định đầy đủ', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1701 - chọn Thuế suất GTGT mặc định bằng 5', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1702 - xóa nhanh Thuế suất GTGT mặc định', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.selectDefaultVatRate('5');
  ...
  test('TC_PMKT-U-00106-1703 - hiển thị numeric Giá trị thuế suất GTGT không bắt buộc', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1704 - tự động điền Giá trị thuế suất GTGT theo mức 10 và 8', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1705 - KCT tự động điền Giá trị thuế suất GTGT bằng 0', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1706 - KKKNT tự động điền Giá trị thuế suất GTGT bằng 0', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1707 - KHAC cho phép nhập Giá trị thuế suất GTGT', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1708 - đổi KHAC về mức 8 cập nhật giá trị và read-only', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.selectDefaultVatRate('KHAC');
    await vatTuPage.fillFormField('Giá trị thuế suất GTGT', '7');
    await vatTuPage.selectDefaultVatRate('8');
  ...
  test('TC_PMKT-U-00106-1709 - hiển thị numeric Thuế nhập khẩu không bắt buộc', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1710 - nhập Thuế nhập khẩu hợp lệ bằng 5.5', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1711 - đổi Bán thành phẩm sang Dịch vụ ẩn Thuế nhập khẩu', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.changeMaterialType();
    await vatTuPage.selectMaterialType('Dịch vụ');
  ...
  test('TC_PMKT-U-00106-1712 - đổi sang loại vật tư khác reset Thuế nhập khẩu', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.fillFormField('Thuế nhập khẩu', '5.5');
    await vatTuPage.changeMaterialType();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1713 - hiển thị numeric Thuế xuất khẩu không bắt buộc', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1714 - nhập Thuế xuất khẩu hợp lệ bằng 2', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1715 - đổi Bán thành phẩm sang Dịch vụ ẩn Thuế xuất khẩu', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.changeMaterialType();
    await vatTuPage.selectMaterialType('Dịch vụ');
    await vatTuPage.openFormTab('Thông tin thuế');
  ...
  test('TC_PMKT-U-00106-1716 - đổi sang loại vật tư khác reset Thuế xuất khẩu', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.fillFormField('Thuế xuất khẩu', '2');
    await vatTuPage.changeMaterialType();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1717 - hiển thị combogrid Thuế Tài nguyên không bắt buộc', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1718 - hiển thị đúng cột, dữ liệu và thứ tự Thuế Tài nguyên', async ({ vatTuPage, db }) => {
    // Chuẩn bị dữ liệu: Lấy mst_thue_tai_nguyen đúng tenant rồi mở combogrid Thuế Tài nguyên.
    const expected = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1719 - Thuế Tài nguyên Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1720 - xác nhận sử dụng Thuế Tài nguyên Ngừng hoạt động', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1721 - hủy sử dụng Thuế Tài nguyên Ngừng hoạt động', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
    const inactive = taxes.find(({ status }) => status === 'NgungHoatDong');
    test.skip(!inactive, 'BLOCK: DB đúng tenant chưa có Thuế Tài nguyên Ngừng hoạt động');
    if (!inactive) return;
  ...
  test('TC_PMKT-U-00106-1722 - chọn Thuế Tài nguyên Hoạt động không hiển thị cảnh báo', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1723 - tìm Thuế Tài nguyên theo Mã', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1724 - tìm Thuế Tài nguyên theo Tên', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1725 - tìm Thuế Tài nguyên theo Thuế suất', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
    const target = taxes[0];
    test.skip(!target, 'BLOCK: DB đúng tenant chưa có Thuế Tài nguyên');
    if (!target) return;
  ...
  test('TC_PMKT-U-00106-1726 - tìm Thuế Tài nguyên theo Trạng thái', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1727 - Enter chọn dòng Thuế Tài nguyên đầu tiên', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1728 - Up và Down di chuyển từng option Thuế Tài nguyên', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1729 - ESC đóng dropdown Thuế Tài nguyên không đổi giá trị', async ({ vatTuPage, db }) => {
    await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
    const valueBefore = await vatTuPage.currentFormOption('Thuế Tài nguyên');
    await vatTuPage.pressTaxKey('Thuế Tài nguyên', 'Escape');
    await expect(vatTuPage.taxDropdown()).toBeHidden();
    expect(await vatTuPage.currentFormOption('Thuế Tài nguyên')).toBe(valueBefore);
  ...
  test('TC_PMKT-U-00106-1730 - icon X xóa nhanh Thuế Tài nguyên', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
    const active = taxes.find(({ status }) => status === 'HoatDong');
    test.skip(!active, 'BLOCK: DB đúng tenant chưa có Thuế Tài nguyên Hoạt động');
    if (!active) return;
  ...
  test('TC_PMKT-U-00106-1731 - đổi sang Dịch vụ ẩn Thuế Tài nguyên', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.changeMaterialType();
    await vatTuPage.selectMaterialType('Dịch vụ');
    await vatTuPage.openFormTab('Thông tin thuế');
  ...
  test('TC_PMKT-U-00106-1732 - đổi sang Bán thành phẩm reset Thuế Tài nguyên', async ({ vatTuPage, db }) => {
    const taxes = await prepareGoodsResourceTaxes(vatTuPage, db, 'Bán thành phẩm');
    const active = taxes.find(({ status }) => status === 'HoatDong');
    test.skip(!active, 'BLOCK: DB đúng tenant chưa có Thuế Tài nguyên Hoạt động');
    if (!active) return;
  ...
  test('TC_PMKT-U-00106-1733 - hiển thị combogrid Thuế tiêu thụ đặc biệt không bắt buộc', async ({ vatTuPage }) => {
    await openGoodsTaxTab(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1734 - hiển thị đúng cột, dữ liệu và thứ tự Thuế tiêu thụ đặc biệt', async ({ vatTuPage, db }) => {
    // Chuẩn bị dữ liệu: Lấy mst_thue_tieu_thu_db đúng tenant rồi mở combogrid Thuế tiêu thụ đặc biệt.
    const expected = await prepareGoodsExciseTaxes(vatTuPage, db, 'Bán thành phẩm');
    // Hành động: Cuộn toàn bộ virtual dropdown để thu thập đủ dữ liệu thay vì chỉ đọc các dòng đang render.
    const actualLabels = await vatTuPage.visibleTaxLabels(expected.length);
    const expectedLabels = expected.map((item) => item.label);
    const headers = (await vatTuPage.taxColumnHeaders().allTextContents()).map((value) => value.trim()).filter(Boolean);
  ...
  test('TC_PMKT-U-00106-1735 - Thuế tiêu thụ đặc biệt Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage, db }) => {
    // Chuẩn bị dữ liệu: Lấy cặp Thuế tiêu thụ đặc biệt Hoạt động/Ngừng hoạt động từ DB đúng tenant.
    const taxes = await prepareGoodsExciseTaxes(vatTuPage, db, 'Bán thành phẩm');
    const pair = statusPair(taxes);
  ...
  test('TC_PMKT-U-00106-1736 - xác nhận sử dụng Thuế tiêu thụ đặc biệt Ngừng hoạt động', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1737 - hủy sử dụng Thuế tiêu thụ đặc biệt Ngừng hoạt động', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1738 - chọn Thuế tiêu thụ đặc biệt Hoạt động không hiển thị cảnh báo', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1739 - tìm Thuế tiêu thụ đặc biệt theo Mã', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1740 - tìm Thuế tiêu thụ đặc biệt theo Tên', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1741 - tìm Thuế tiêu thụ đặc biệt theo Thuế suất', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1742 - tìm Thuế tiêu thụ đặc biệt theo Trạng thái', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1743 - Enter chọn dòng Thuế tiêu thụ đặc biệt đầu tiên', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1744 - Up và Down di chuyển từng option Thuế tiêu thụ đặc biệt', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1745 - ESC đóng dropdown Thuế tiêu thụ đặc biệt không đổi giá trị', async ({ vatTuPage, db }) => {
    // Chuẩn bị dữ liệu: Mở combogrid từ danh mục DB đúng tenant và lưu giá trị ban đầu.
    await prepareGoodsExciseTaxes(vatTuPage, db, 'Bán thành phẩm');
    const valueBefore = await vatTuPage.currentFormOption('Thuế tiêu thụ đặc biệt');
  ...
  test('TC_PMKT-U-00106-1746 - icon X xóa nhanh Thuế tiêu thụ đặc biệt', async ({ vatTuPage, db }) => {
  ...
  test('TC_PMKT-U-00106-1747 - đổi sang Dịch vụ ẩn tab Đơn vị quy đổi', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm tại tab Đơn vị quy đổi theo pre-condition testcase.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1748 - đổi từ Dịch vụ về Bán thành phẩm hiện lại tab Đơn vị quy đổi', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm rồi đổi sang Dịch vụ để tab Đơn vị quy đổi bị ẩn.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.changeMaterialType();
    ...
    // Hành động: Thay đổi tính chất > chọn lại Bán thành phẩm.
    await vatTuPage.changeMaterialType();
    await vatTuPage.selectMaterialType('Bán thành phẩm');

    // Xác nhận UI: Form tải lại đúng loại Bán thành phẩm và tab Đơn vị quy đổi hiển thị bình thường.
    await expect(vatTuPage.semiFinishedProductMaterialTypeField()).toContainText('Bán thành phẩm');
    await expect(vatTuPage.formTab('Đơn vị quy đổi')).toBeVisible();
  });

  test('TC_PMKT-U-00106-1749 - đổi sang Dịch vụ hiện tab Đơn vị tính khác', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm tại tab Đơn vị quy đổi theo pre-condition testcase.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1750 - đổi từ Dịch vụ về Bán thành phẩm ẩn tab Đơn vị tính khác', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm rồi đổi sang Dịch vụ để tab Đơn vị tính khác xuất hiện.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.changeMaterialType();
    ...
    // Xác nhận UI: Form tải lại đúng loại Bán thành phẩm và ẩn hoàn toàn tab Đơn vị tính khác.
    await expect(vatTuPage.semiFinishedProductMaterialTypeField()).toContainText('Bán thành phẩm');
    await expect(vatTuPage.formTab('Đơn vị tính khác')).toBeHidden();
  });

  test('TC_PMKT-U-00106-1751 - hiển thị đúng control trên dòng lưới Đơn vị quy đổi', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm và tab Đơn vị quy đổi.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.openFormTab('Đơn vị quy đổi');
  ...
  test('TC_PMKT-U-00106-1752 - thêm dòng Đơn vị quy đổi với thông tin đầy đủ', async ({ vatTuPage }) => {
    ...
    await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1753 - combogrid Đơn vị tính quy đổi khớp cột dữ liệu DB và thứ tự trạng thái', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Lấy toàn bộ Đơn vị tính từ DB đúng tenant và mở combogrid trên dòng quy đổi.
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); await vatTuPage.openFirstConversionUnitDropdown();
  ...
  test('TC_PMKT-U-00106-1754 - Đơn vị tính quy đổi Ngừng hoạt động hiển thị chữ màu xám', async ({ vatTuPage }) => {
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); const inactive = units.find((u) => u.status === 'NgungHoatDong');
  ...
  test('TC_PMKT-U-00106-1755 - xác nhận sử dụng Đơn vị tính quy đổi Ngừng hoạt động', async ({ vatTuPage }) => {
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); const inactive = units.find((u) => u.status === 'NgungHoatDong');
    test.skip(!inactive, 'DB không có Đơn vị tính Ngừng hoạt động'); if (!inactive) return;
    await vatTuPage.openFirstConversionUnitDropdown(); await vatTuPage.searchFirstConversionUnit(inactive.code);
    await expect(vatTuPage.conversionUnitOption(inactive.label), 'Combogrid phải hiển thị Đơn vị tính Ngừng hoạt động theo mã DB').toBeVisible();
  ...
  test('TC_PMKT-U-00106-1756 - hủy sử dụng Đơn vị tính quy đổi Ngừng hoạt động', async ({ vatTuPage }) => {
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); const inactive = units.find((u) => u.status === 'NgungHoatDong');
    test.skip(!inactive, 'DB không có Đơn vị tính Ngừng hoạt động'); if (!inactive) return;
    await vatTuPage.openFirstConversionUnitDropdown(); await vatTuPage.searchFirstConversionUnit(inactive.code);
    await expect(vatTuPage.conversionUnitOption(inactive.label), 'Combogrid phải hiển thị Đơn vị tính Ngừng hoạt động theo mã DB').toBeVisible();
  ...
  test('TC_PMKT-U-00106-1757 - chọn Đơn vị tính quy đổi Hoạt động không hiển thị cảnh báo', async ({ vatTuPage }) => {
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); const active = units.find((u) => u.status === 'HoatDong');
  ...
  test('TC_PMKT-U-00106-1758 - tìm Đơn vị tính quy đổi theo Mã', async ({ vatTuPage }) => {
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); const unit = units[0]; test.skip(!unit, 'DB không có Đơn vị tính'); if (!unit) return;
  ...
  test('TC_PMKT-U-00106-1759 - tìm Đơn vị tính quy đổi theo Tên', async ({ vatTuPage }) => {
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); const unit = units[0]; test.skip(!unit, 'DB không có Đơn vị tính'); if (!unit) return;
    await vatTuPage.openFirstConversionUnitDropdown(); await vatTuPage.searchFirstConversionUnit(unit.name);
    expect((await vatTuPage.visibleMainUnitEntries()).map(({ label }) => label)).toContain(unit.label);
  });

  test('TC_PMKT-U-00106-1760 - tìm Đơn vị tính quy đổi theo Trạng thái', async ({ vatTuPage }) => {
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); await vatTuPage.openFirstConversionUnitDropdown(); await vatTuPage.searchFirstConversionUnit('Hoạt động');
  ...
  test('TC_PMKT-U-00106-1761 - Enter chọn dòng Đơn vị tính quy đổi đầu tiên', async ({ vatTuPage }) => {
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); const keyword = units[0]?.code.slice(0, 1); test.skip(!keyword, 'DB không có dữ liệu tìm kiếm'); if (!keyword) return;
  ...
  test('TC_PMKT-U-00106-1762 - Up Down di chuyển dòng Đơn vị tính quy đổi', async ({ vatTuPage }) => {
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1763 - ESC đóng dropdown Đơn vị tính quy đổi không đổi giá trị', async ({ vatTuPage }) => {
    await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); await vatTuPage.openFirstConversionUnitDropdown(); await vatTuPage.pressFirstConversionUnitKey('Escape');
  ...
  test('TC_PMKT-U-00106-1764 - icon X xóa nhanh Đơn vị tính quy đổi', async ({ vatTuPage }) => {
    const { units } = await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); const active = units.find((u) => u.status === 'HoatDong'); test.skip(!active, 'DB không có Đơn vị tính Hoạt động'); if (!active) return;
  ...
  test('TC_PMKT-U-00106-1765 - hiển thị nút Thêm nhanh Đơn vị tính quy đổi theo quyền', async ({ vatTuPage }) => {
    await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm');
    await vatTuPage.openFirstConversionUnitDropdown();
    await expect(
  ...
  test('TC_PMKT-U-00106-1766 - giao diện form Thêm nhanh Đơn vị tính quy đổi', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1765 - tài khoản full quyền không hiển thị nút (+) Thêm nhanh Đơn vị tính');
  });

  test('TC_PMKT-U-00106-1767 - validate bắt buộc form Thêm nhanh Đơn vị tính quy đổi', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1765 - không thể mở form Thêm nhanh Đơn vị tính');
  });

  test('TC_PMKT-U-00106-1768 - validate trùng Mã form Thêm nhanh Đơn vị tính quy đổi', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1765 - không thể mở form Thêm nhanh Đơn vị tính');
  });

  test('TC_PMKT-U-00106-1769 - boundary Mã form Thêm nhanh Đơn vị tính quy đổi', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1765 - không thể mở form Thêm nhanh Đơn vị tính');
  });

  test('TC_PMKT-U-00106-1770 - boundary Tên form Thêm nhanh Đơn vị tính quy đổi', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1765 - không thể mở form Thêm nhanh Đơn vị tính');
  });

  test('TC_PMKT-U-00106-1771 - lưu Thêm nhanh Đơn vị tính quy đổi và tự động điền', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1765 - không thể mở form Thêm nhanh Đơn vị tính');
  });

  test('TC_PMKT-U-00106-1772 - hủy form Thêm nhanh Đơn vị tính quy đổi', async () => {
    test.skip(true, 'BLOCK: bị chặn bởi TC1765 - không thể mở form Thêm nhanh Đơn vị tính');
  });

  test('TC_PMKT-U-00106-1773 - control Numeric Tỷ lệ quy đổi mặc định trống', async ({ vatTuPage }) => {
    await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1774 - validate Đơn vị quy đổi trùng Đơn vị tính chính', async ({ vatTuPage }) => {
  ...
  test('TC_PMKT-U-00106-1775 - validate hai dòng chọn trùng Đơn vị tính quy đổi', async ({ vatTuPage }) => {
    const { units } = await openVatTuWithCatalogues(vatTuPage);
  ...
  test('TC_PMKT-U-00106-1776 - validate Tỷ lệ quy đổi bằng 0', async ({ vatTuPage }) => {
    const { units } = await openVatTuWithCatalogues(vatTuPage); const activeUnits = units.filter((unit) => unit.status === 'HoatDong');
    test.skip(activeUnits.length < 2, 'DB cần tối thiểu hai Đơn vị tính Hoạt động');
    const generator = new TestDataGenerator(); await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1777 - validate Tỷ lệ quy đổi nhỏ hơn 0', async ({ vatTuPage }) => {
    const { units } = await openVatTuWithCatalogues(vatTuPage); const activeUnits = units.filter((unit) => unit.status === 'HoatDong');
    test.skip(activeUnits.length < 2, 'DB cần tối thiểu hai Đơn vị tính Hoạt động');
    const generator = new TestDataGenerator(); await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1778 - Phép tính mặc định Nhân và chỉ có Nhân Chia', async ({ vatTuPage }) => {
    await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm');
    await expect(vatTuPage.conversionOperationCell('Nhân')).toBeVisible();
  ...
  test('TC_PMKT-U-00106-1779 - chọn Phép tính Chia thành công', async ({ vatTuPage }) => {
    await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); await vatTuPage.selectConversionOperation('Chia');
    await expect(vatTuPage.conversionOperationCell('Chia')).toBeVisible();
  });

  test('TC_PMKT-U-00106-1780 - Mô tả là Textbox read-only', async ({ vatTuPage }) => {
    await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); const description = vatTuPage.conversionDescription();
    await expect(description).toBeVisible(); await expect(description).toHaveAttribute('readonly', '');
  });

  test('TC_PMKT-U-00106-1781 - Mô tả tự tính đúng với phép Nhân', async ({ vatTuPage }) => {
    const { units } = await openVatTuWithCatalogues(vatTuPage); const activeUnits = units.filter((unit) => unit.status === 'HoatDong');
    ...
    const ratio = 12;
    await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm'); await vatTuPage.openMainUnitDropdown(); await vatTuPage.selectMainUnit(mainUnit);
  ...
  test('TC_PMKT-U-00106-1782 - Mô tả tự tính đúng với phép Chia', async ({ vatTuPage }) => {
    const { units } = await openVatTuWithCatalogues(vatTuPage); const activeUnits = units.filter((unit) => unit.status === 'HoatDong');
    test.skip(activeUnits.length < 2, 'DB cần tối thiểu hai Đơn vị tính Hoạt động'); const mainUnit = activeUnits[0]!; const conversionUnit = activeUnits[1]!;
    const ratio = 12;
  ...
  test('TC_PMKT-U-00106-1783 - xóa dòng Đơn vị quy đổi không cảnh báo', async ({ vatTuPage }) => {
    await prepareGoodsConversionGrid(vatTuPage, 'Bán thành phẩm'); await expect(vatTuPage.conversionRowControls('spinbutton')).toHaveCount(1);
  ...
  test('TC_PMKT-U-00106-1784 - xóa dòng quy đổi cuối cùng rồi Lưu và kiểm tra DB', async ({ vatTuPage, db }, testInfo) => {
    ...
    const material = fullGoodsData('TC818', group, mainUnit, 'Bán thành phẩm');
    await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm');
    ...
    await verifyFullGoodsSavedInDatabase(db, credentials.username, material, selection, true, 0, 'Bán thành phẩm');
  });

  test('TC_PMKT-U-00106-1785 - Lưu Bán thành phẩm đầy đủ trạng thái Hoạt động và kiểm tra DB', async ({ vatTuPage, db }) => {
    const credentials = requireCredentials(); const { groups, units } = await openVatTuWithCatalogues(vatTuPage);
    const group = groups.find((item) => item.status === 'HoatDong'); const mainUnit = units.find((item) => item.status === 'HoatDong');
    test.skip(!group || !mainUnit, 'DB cần Nhóm vật tư và Đơn vị tính Hoạt động'); if (!group || !mainUnit) return;
    const material = fullGoodsData('TC819', group, mainUnit, 'Bán thành phẩm');
    await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm');
    const selection = await vatTuPage.fillFullGoodsMaterial(material, 'inventory-material');
    ...
    await verifyFullGoodsSavedInDatabase(db, credentials.username, material, selection, true, 1, 'Bán thành phẩm');
  });

  test('TC_PMKT-U-00106-1786 - Lưu Bán thành phẩm chỉ với trường bắt buộc và kiểm tra mặc định DB', async ({ vatTuPage, db }) => {
    ...
    await verifyRequiredGoodsSavedInDatabase(db, credentials.username, { code, name, mainUnit, active: true, defaults }, 'Bán thành phẩm');
  });

  test('TC_PMKT-U-00106-1787 - Lưu Bán thành phẩm đầy đủ trạng thái Ngừng hoạt động và kiểm tra DB', async ({ vatTuPage, db }) => {
    const credentials = requireCredentials(); const { groups, units } = await openVatTuWithCatalogues(vatTuPage);
    const group = groups.find((item) => item.status === 'HoatDong'); const mainUnit = units.find((item) => item.status === 'HoatDong');
    test.skip(!group || !mainUnit, 'DB cần Nhóm vật tư và Đơn vị tính Hoạt động'); if (!group || !mainUnit) return;
    const material = fullGoodsData('TC821', group, mainUnit, 'Bán thành phẩm');
    await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm');
    const selection = await vatTuPage.fillFullGoodsMaterial(material, 'inventory-material');
    ...
    await verifyFullGoodsSavedInDatabase(db, credentials.username, material, selection, false, 1, 'Bán thành phẩm');
  });

  test('TC_PMKT-U-00106-1788 - Lưu và Thêm mới reset form, hiển thị danh sách và kiểm tra DB', async ({ vatTuPage, db }) => {
    const credentials = requireCredentials(); const { groups, units } = await openVatTuWithCatalogues(vatTuPage);
    const group = groups.find((item) => item.status === 'HoatDong'); const mainUnit = units.find((item) => item.status === 'HoatDong');
    test.skip(!group || !mainUnit, 'DB cần Nhóm vật tư và Đơn vị tính Hoạt động'); if (!group || !mainUnit) return;
    const material = fullGoodsData('TC822', group, mainUnit, 'Bán thành phẩm');
    await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm');
    const selection = await vatTuPage.fillFullGoodsMaterial(material, 'inventory-material');
  ...
  test('TC_PMKT-U-00106-1789 - icon X đóng form ngay sau khi Lưu và Thêm mới reset', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Tạo Bán thành phẩm chỉ với trường bắt buộc và đưa form về trạng thái reset sau Lưu và Thêm mới.
    ...
    await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm'); await vatTuPage.fillRequiredInventoryMaterialFields(code, name, mainUnit);
  ...
  test('TC_PMKT-U-00106-1790 - icon X hiển thị cảnh báo sau khi thay đổi form reset', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Lưu Bán thành phẩm tối thiểu, reset form rồi nhập lại Tên vật tư unique.
    const { units } = await openVatTuWithCatalogues(vatTuPage); const mainUnit = units.find((item) => item.status === 'HoatDong');
    test.skip(!mainUnit, 'DB cần Đơn vị tính Hoạt động'); if (!mainUnit) return;
  ...
  test('TC_PMKT-U-00106-1791 - Hủy cảnh báo icon X giữ nguyên dữ liệu sau reset', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Lưu Bán thành phẩm tối thiểu, reset form, nhập lại Tên và mở cảnh báo bằng icon X.
    const { units } = await openVatTuWithCatalogues(vatTuPage); const mainUnit = units.find((item) => item.status === 'HoatDong');
    test.skip(!mainUnit, 'DB cần Đơn vị tính Hoạt động'); if (!mainUnit) return;
  ...
  test('TC_PMKT-U-00106-1792 - Xác nhận cảnh báo icon X đóng form sau reset', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Lưu Bán thành phẩm tối thiểu, reset form, nhập lại dữ liệu và mở cảnh báo bằng icon X.
    const { units } = await openVatTuWithCatalogues(vatTuPage); const mainUnit = units.find((item) => item.status === 'HoatDong');
    test.skip(!mainUnit, 'DB cần Đơn vị tính Hoạt động'); if (!mainUnit) return;
  ...
  test('TC_PMKT-U-00106-1793 - nút Hủy đóng form ngay sau khi Lưu và Thêm mới reset', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Tạo Bán thành phẩm tối thiểu và giữ form reset không có thay đổi mới.
    const { units } = await openVatTuWithCatalogues(vatTuPage); const mainUnit = units.find((item) => item.status === 'HoatDong');
    test.skip(!mainUnit, 'DB cần Đơn vị tính Hoạt động'); if (!mainUnit) return;
  ...
  test('TC_PMKT-U-00106-1794 - nút Hủy hiển thị cảnh báo sau khi thay đổi form reset', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Lưu Bán thành phẩm tối thiểu, reset form rồi nhập lại Tên vật tư unique.
    const { units } = await openVatTuWithCatalogues(vatTuPage); const mainUnit = units.find((item) => item.status === 'HoatDong');
    test.skip(!mainUnit, 'DB cần Đơn vị tính Hoạt động'); if (!mainUnit) return;
  ...
  test('TC_PMKT-U-00106-1795 - Hủy cảnh báo nút Hủy giữ nguyên dữ liệu sau reset', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Lưu Bán thành phẩm tối thiểu, reset form, nhập lại Tên và mở cảnh báo bằng nút Hủy.
    const { units } = await openVatTuWithCatalogues(vatTuPage); const mainUnit = units.find((item) => item.status === 'HoatDong');
    test.skip(!mainUnit, 'DB cần Đơn vị tính Hoạt động'); if (!mainUnit) return;
  ...
  test('TC_PMKT-U-00106-1796 - Xác nhận cảnh báo nút Hủy đóng form sau reset', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Lưu Bán thành phẩm tối thiểu, reset form, nhập lại dữ liệu và mở cảnh báo bằng nút Hủy.
    const { units } = await openVatTuWithCatalogues(vatTuPage); const mainUnit = units.find((item) => item.status === 'HoatDong');
    test.skip(!mainUnit, 'DB cần Đơn vị tính Hoạt động'); if (!mainUnit) return;
  ...
  test('TC_PMKT-U-00106-1797 - icon X đóng form chưa thay đổi mà không cảnh báo', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm mới và không thay đổi bất kỳ trường nào.
    await vatTuPage.openFromDanhMuc(); await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1798 - icon X hiển thị cảnh báo khi form có thay đổi', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm và nhập Tên vật tư unique nhưng chưa lưu.
    const changedName = new TestDataGenerator().uniqueKeyword('TC322');
    await vatTuPage.openFromDanhMuc(); await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm'); await vatTuPage.materialNameInput().fill(changedName);
  ...
  test('TC_PMKT-U-00106-1799 - Hủy cảnh báo icon X giữ nguyên dữ liệu chưa lưu', async ({ vatTuPage }) => {
    ...
    await vatTuPage.openFromDanhMuc(); await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm'); await vatTuPage.materialNameInput().fill(changedName); await vatTuPage.closeCreatingMaterial();
  ...
  test('TC_PMKT-U-00106-1800 - Xác nhận cảnh báo icon X đóng form chưa lưu', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Nhập Tên vật tư unique rồi mở popup xác nhận bằng icon X.
  ...
  test('TC_PMKT-U-00106-1801 - nút Hủy đóng form chưa thay đổi mà không cảnh báo', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm mới và không thay đổi bất kỳ trường nào.
    await vatTuPage.openFromDanhMuc(); await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm');
    // Hành động: Nhấn nút Hủy ở cuối form.
    await vatTuPage.cancelCreatingMaterial();
  ...
  test('TC_PMKT-U-00106-1802 - nút Hủy hiển thị cảnh báo khi form có thay đổi', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm và nhập Tên vật tư unique nhưng chưa lưu.
  ...
  test('TC_PMKT-U-00106-1803 - Hủy cảnh báo nút Hủy giữ nguyên dữ liệu chưa lưu', async ({ vatTuPage }) => {
    ...
    await vatTuPage.openFromDanhMuc(); await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm'); await vatTuPage.materialNameInput().fill(changedName); await vatTuPage.cancelCreatingMaterial();
    // Hành động: Nhấn Hủy trên popup xác nhận.
    await vatTuPage.dismissCloseConfirmation();
    // Xác nhận UI: Popup đóng, form còn mở và Tên vật tư giữ nguyên.
    await expect(vatTuPage.closeConfirmationDialog).toBeHidden(); await expect(vatTuPage.createMaterialDialog).toBeVisible(); await expect(vatTuPage.materialNameInput()).toHaveValue(changedName);
  ...
  test('TC_PMKT-U-00106-1804 - Xác nhận cảnh báo nút Hủy đóng form chưa lưu', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Nhập Tên vật tư unique rồi mở popup xác nhận bằng nút Hủy.
  ...
  test('TC_PMKT-U-00106-1805 - chặn lưu khi bỏ trống toàn bộ trường bắt buộc', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm và giữ trống toàn bộ trường bắt buộc.
    await vatTuPage.openFromDanhMuc(); await vatTuPage.openMaterialTypePopup(); await vatTuPage.selectMaterialType('Bán thành phẩm');
  ...
  test('TC_PMKT-U-00106-1806 - Hủy bỏ khi chưa nhập hoặc thay đổi dữ liệu trên form', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Mở form Bán thành phẩm và không thay đổi bất kỳ trường nào.
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    // Hành động: Nhấn nút Hủy dưới chân form.
    await vatTuPage.cancelCreatingMaterial();
    // Xác nhận UI: Form đóng ngay, quay về danh sách và không hiển thị popup xác nhận.
    await expect(vatTuPage.createMaterialDialog).toBeHidden();
    await expect(vatTuPage.closeConfirmationDialog).toBeHidden();
    await expect(vatTuPage.materialSearchInput()).toBeVisible();
  });

  test('TC_PMKT-U-00106-1807 - Hủy bỏ khi form đã có thay đổi dữ liệu', async ({ vatTuPage }) => {
    // Chuẩn bị dữ liệu: Nhập Tên vật tư unique để form có thay đổi chưa lưu.
    const changedName = new TestDataGenerator().uniqueKeyword('TC1807');
    await vatTuPage.openFromDanhMuc();
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.materialNameInput().fill(changedName);
    // Hành động: Nhấn Hủy, chọn Hủy trên popup, sau đó mở lại popup và Xác nhận đóng.
    await vatTuPage.cancelCreatingMaterial();
    await expect(vatTuPage.closeConfirmationDialog).toBeVisible();
    await vatTuPage.dismissCloseConfirmation();
    await expect(vatTuPage.createMaterialDialog).toBeVisible();
    await expect(vatTuPage.materialNameInput()).toHaveValue(changedName);
    await vatTuPage.cancelCreatingMaterial();
    await vatTuPage.confirmClose();
    // Xác nhận UI: Popup và form đóng, màn danh sách vật tư hiển thị.
    await expect(vatTuPage.closeConfirmationDialog).toBeHidden();
    await expect(vatTuPage.createMaterialDialog).toBeHidden();
    await expect(vatTuPage.materialSearchInput()).toBeVisible();
  });

  test('TC_PMKT-U-00106-1809 - tự động trim khoảng trắng đầu cuối khi lưu', async ({ vatTuPage, db, materialCleanup }) => {
    // Chuẩn bị dữ liệu: Sinh mã và tên unique, lấy Đơn vị tính Hoạt động từ DB đúng tenant.
    const credentials = requireCredentials();
    const { units } = await openVatTuWithCatalogues(vatTuPage);
    const mainUnit = units.find((unit) => unit.status === 'HoatDong');
    test.skip(!mainUnit, 'DB cần Đơn vị tính Hoạt động');
    if (!mainUnit) return;
    const generator = new TestDataGenerator();
    const code = generator.uniqueCode('TC1809');
    const name = generator.uniqueKeyword('TC1809');

    // Hành động: Mở form Bán thành phẩm > nhập mã, tên có khoảng trắng đầu/cuối > nhập đủ trường bắt buộc > Lưu.
    await vatTuPage.openMaterialTypePopup();
    await vatTuPage.selectMaterialType('Bán thành phẩm');
    await vatTuPage.fillRequiredInventoryMaterialFields(`  ${code}  `, `  ${name}  `, mainUnit);
    await vatTuPage.saveMaterial();
    await expect(vatTuPage.successNotification()).toContainText('Thêm mới thành công');
    materialCleanup.register(code);

    // Xác nhận DB: Bản ghi đúng tenant đã loại bỏ khoảng trắng đầu/cuối của Mã và Tên.
    await expect.poll(async () => (await db.vatTu.findByCodeForDefaultTenant(credentials.username, code)).length).toBe(1);
    const [saved] = await db.vatTu.findByCodeForDefaultTenant(credentials.username, code);
